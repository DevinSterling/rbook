...
use crate::epub::manifest::{EpubManifest, EpubManifestData};
use crate::epub::metadata::{EpubMetadata, EpubMetadataData, EpubVersion};
...
impl Epub {
    ...
    #[doc = doc::inherent!(Ebook, metadata)]
    /// # See Also
    ...
    #[doc = doc::inherent!(Ebook, manifest)]
    ...
    #[doc = doc::inherent!(Ebook, read_resource_bytes)]
    /// # See Also
    /// - [`Self::copy_resource`] for path normalization details.
...
impl EpubOpenOptions {
    ...
    /// - Has an [**identifier**](EpubMetadata::identifier).
    /// - Has a [**title**](EpubMetadata::title).
    /// - Has a primary [**language**](EpubMetadata::language).
    ...
    ///   [`EpubSpineEntry::manifest_entry`](spine::EpubSpineEntry::manifest_entry),
    ///   [`EpubTocEntry::resource`](toc::EpubTocEntry::resource)).
    ///
    /// - **Reader Content**:
